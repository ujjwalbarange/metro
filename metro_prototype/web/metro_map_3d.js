...
function getTrainCoaches(lineName, fraction, trainDirection) {
  ...
  const COACH_SPACING = 2.68 * scale;
...
async function init() {
  ...
  map.on("load", async () => {
    ...
    map.addLayer({
      id: "station-dots", type: "circle", source: "all-stations",
      paint: { "circle-radius": 6, "circle-color": "#fff", "circle-stroke-color": "#333", "circle-stroke-width": 2 }
    });
    map.addLayer({
      id: "station-names", type: "symbol", source: "all-stations",
      layout: {
        "text-field": ["get", "name"], "text-size": 11, "text-offset": [0, 1.5],
    ...
    if (orangeF.length > 0) {
      ...
      map.addLayer({
        id: "orange-casing", type: "line", source: "route-orange",
        paint: { "line-color": "#e65100", "line-width": 7, "line-opacity": 0.5 }
      });
      map.addLayer({
        id: "orange-line", type: "line", source: "route-orange",
    ...
    if (aquaF.length > 0) {
      ...
      map.addLayer({
        id: "aqua-casing", type: "line", source: "route-aqua",
        paint: { "line-color": "#006064", "line-width": 7, "line-opacity": 0.5 }
      });
      map.addLayer({
        id: "aqua-line", type: "line", source: "route-aqua",
    ...
    map.addLayer({
      id: "route-all-line", type: "line", source: "route-all",
  ...
  window.__metro3d_calculateRoute = async (fromLng, fromLat, toName) => {
    ...
    if (result) {
      ...
      return JSON.stringify({
        walkDistM: result.walkDistM, walkTimeMin: result.walkTimeMin,
